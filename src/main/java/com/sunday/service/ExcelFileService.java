...
public class ExcelFileService {
    ...
    public void generateExcelOfTodayStock(String dir) {
        ...
        pt.applyBorders(sheet);
        try (var outputStream = new FileOutputStream(new File(dir + "\\" + LocalDate.now().toString() + "-stock.xlsx"))) {
            workbook.write(outputStream);
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
    ...
    public void generateExcelOfUnpaidCustomer(String dir){
        ...
        pt.applyBorders(sheet);
        try (var outputStream = new FileOutputStream(new File(dir + "\\" + LocalDate.now().toString() + "-unpaid customer.xlsx"))) {
            workbook.write(outputStream);
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
